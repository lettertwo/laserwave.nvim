...
local function transform(palette)
  local colors = stringify_colors({
    ...
    black = palette.OLD_LAVENDER,
    bright_black = palette.AFRICAN_VIOLET,
    red = palette.HOT_PINK,
    bright_red = palette.VIVID_RASPBERRY,
    green = palette.PEARL_AQUA,
    bright_green = palette.PEARL_AQUA,
    yellow = palette.MUSTARD,
    bright_yellow = palette.GARDENIA,
    blue = palette.MAXIMUM_BLUE,
    bright_blue = palette.MAXIMUM_BLUE,
    magenta = palette.AFRICAN_VIOLET,
    bright_magenta = palette.HOT_PINK,
    cyan = palette.POWDER_BLUE,
