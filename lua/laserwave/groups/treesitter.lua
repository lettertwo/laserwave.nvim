...
local treesitter = {
  ...
  ["@keyword.function"]            = "@operator", -- keywords that define a function (e.g. `func` in Go, `def` in Python)
  ["@keyword.jsdoc"]               = "@type", -- jsdoc
  ["@keyword.modifier"]            = "@keyword.conditional", -- keywords modifying other constructs (e.g. `const`, `static`, `public`)
