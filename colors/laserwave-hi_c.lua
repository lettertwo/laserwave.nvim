-- GENERATED ON 2026-01-12 AT 16:04:46
-- name:     laserwave-hi_c
...
SnacksPickerGitStatusAdded = {fg = "#1CD4ED"},
SnacksPickerGitStatusDeleted = {fg = "#FF55C0"},
SnacksPickerGitStatusModified = {fg = "#3FEBBF"},
SnacksPickerGitStatusStaged = {fg = "#1CD4ED"},
