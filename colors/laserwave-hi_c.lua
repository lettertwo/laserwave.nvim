-- GENERATED ON 2024-02-19 AT 13:30:13
-- name:     laserwave-hi_c
...
lCursor = {link = "Cursor"},
CursorLine = {bg = "#292031"},
ColorColumn = {link = "CursorLine"},
CursorColumn = {link = "CursorLine"},
CursorLineFold = {fg = "#D686F4", bg = "#292031"},
CursorLineNr = {fg = "#DDCBE6", bg = "#292031"},
CursorLineSign = {fg = "#D686F4", bg = "#292031"},
Define = {fg = "#FF55C0"},
Delimiter = {fg = "#B5A9C8"},
DiffAdd = {bg = "#343F48"},
...
Question = {fg = "#1CD4ED"},
QuickFixLine = {bg = "#432F4E", bold = true},
...
LspReferenceRead = {bg = "#432F4E", underline = true},
LspReferenceText = {bg = "#432F4E", underline = true},
LspReferenceWrite = {bg = "#432F4E", underline = true},
