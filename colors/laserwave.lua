...
--%% begin compiled_specs %%--
  spec = {
    ...
    Ignore = {fg = "#7B6995"},
    Include = {fg = "#74DFC4", italic = true},
    Keyword = {fg = "#74DFC4", italic = true},
    Label = {fg = "#40B4C4"},
    LineNr = {fg = "#4F435F"},
    ...
    Statement = {fg = "#74DFC4", italic = true},
  ...
  plugins = {
    ...
    obsidian = {
      ...
      ObsidianTag = {fg = "#40B4C4", italic = true},
    ...
    treesitter = {
      ...
      ["@string.regexp"] = {fg = "#74DFC4"},
      ["@string.special.url"] = {fg = "#40B4C4", underline = true},
