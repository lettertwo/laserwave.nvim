...
Question = {fg = "#41B5C5"},
QuickFixLine = {bg = "#5C4568", bold = true},
...
LspReferenceRead = {bg = "#5C4568", underline = true},
LspReferenceText = {bg = "#5C4568", underline = true},
LspReferenceWrite = {bg = "#5C4568", underline = true},
...
MiniPickPreviewRegion = {fg = "#EB65B9", bg = "#5C4568", bold = true},
